...
##################################
managerip=$(docker-machine ip redis-manager1)
workeroneip=$(docker-machine ip redis-worker1)
workertwoip=$(docker-machine ip redis-worker2)

declare -a dockerMachinesIps=($managerip $workeroneip $workertwoip)
declare -a ports=(7001 7002 7003)
